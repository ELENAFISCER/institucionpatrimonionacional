...
import imagenQr from "/src/images/qr.jpg"; 
  ...
  <Layout>
    ...
    >
      ...
      <img
        src={imagenQr}
        alt="Genera QR"
        style={{ maxWidth: "55%", height: "auto", marginBottom: "20px" }}
      />
      ...
      <p style={{ maxWidth: "800px", textAlign: "justify", marginBottom: "40px" }}>
        ...
        cuida de más de 1.000 inmuebles y más de 170.000 piezas artísticas.<b> Desde nuestra app
        te ofrecemos la posibilidad de crear tu propio QR.Introduce el texto deseado en el cuadro
        para descubrirlo. </b>
      </p>
